...
public class AbstractKmeans<Centroid, Point> {

    public interface DistanceFunction<Centroid, Point> {

        void distance(boolean[] changed, double[][] distances,
                      Centroid[] centroids, Point[] points);
    }

    public interface CenterFunction<Centroid, Point> {

        void center(boolean[] changed, int[] assignments,
                    Centroid[] centroids, Point[] points);
    }
    ...
    public AbstractKmeans(Centroid[] centroids,
                          Point[] points,
                          DistanceFunction<Centroid, Point> distanceFunction,
                          CenterFunction<Centroid, Point> centerFunction) {
