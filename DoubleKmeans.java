...
public class DoubleKmeans extends AbstractKmeans<double[], double[]> {
    ...
    protected static class DistanceFunction implements AbstractKmeans.DistanceFunction<double[], double[]> {
    ...
    protected static class CenterFunction implements AbstractKmeans.CenterFunction<double[], double[]> {
    ...
    public DoubleKmeans(double[][] centroids, double[][] points, DoubleDistanceFunction doubleDistanceFunction) {
